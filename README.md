...
## 🔥 Latest News
* Oct 09, 2025: 👋 Release [Qwen-Image-fp8-Lightning-4steps-V1.0](https://huggingface.co/lightx2v/Qwen-Image-Lightning/blob/main/Qwen-Image-Edit-2509/Qwen-Image-Edit-2509-Lightning-4steps-V1.0-fp32.safetensors) and its [bf16 version](https://huggingface.co/lightx2v/Qwen-Image-Lightning/blob/main/Qwen-Image-Edit-2509/Qwen-Image-Edit-2509-Lightning-4steps-V1.0-fp32.safetensors) for base model of[qwen_image_fp8_e4m3fn.safetensors](https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_fp8_e4m3fn.safetensors). Please see [the issue of previous 4-step lightning LoRA when using on fp8](https://github.com/ModelTC/Qwen-Image-Lightning/issues/32) and [the comparison between previous 4-step lightning and the dedicated 4-step lightning lora for fp8 base](#-comparison-between-Qwen-Image-4-step-lightning-and-Qwen-Image-fp8-4-step-lightning).
...
## 📑 Comparison between Qwen-Image-Lightning and Qwen-Image-fp8-Lightning
The utilization of existing LoRA weights with the [qwen_image_fp8_e4m3fn.safetensors](https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_fp8_e4m3fn.safetensors) base model results in the grid artifacts reported in [Issue #32](https://github.com/ModelTC/Qwen-Image-Lightning/issues/32), wherein generated images exhibit a grid-like pattern. This artifact stems from the fact that the [qwen_image_fp8_e4m3fn.safetensors] model was produced by directly downcasting the [original bf16 weights](https://huggingface.co/Qwen/Qwen-Image/tree/main/transformer), rather than employing a calibrated conversion process with appropriate scaling.

In response to the prevalent use of this model, we have released a new set of Lightning LoRA weights specifically optimized for this base. These weights were generated by distilling the qwen_image_fp8_e4m3fn.safetensors model using bf16 guidance, thereby mitigating the artifact issue. An alternative solution we provide is [a newly released FP8 base weight](), converted with scaling to ensure better compatibility with the existing suite of LoRA weights trained on BF16 bases. A comparative analysis is provided below. 

| [bf16 base](https://huggingface.co/Qwen/Qwen-Image/tree/main/transformer) + [LoRA trained on bf16 base](https://huggingface.co/lightx2v/Qwen-Image-Lightning/blob/main/Qwen-Image-Lightning-4steps-V2.0.safetensors) | [fp8 base](https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_fp8_e4m3fn.safetensors) + [LoRA trained on bf16 base](https://huggingface.co/lightx2v/Qwen-Image-Lightning/blob/main/Qwen-Image-Lightning-4steps-V2.0.safetensors) | [fp8 base](https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_fp8_e4m3fn.safetensors) + [LoRA trained on fp8 base]() | [scaled fp8 base](https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_fp8_e4m3fn.safetensors) + [LoRA trained on bf16 base](https://huggingface.co/lightx2v/Qwen-Image-Lightning/blob/main/Qwen-Image-Lightning-4steps-V2.0.safetensors) |
|---|---|---|---|
| ![111](https://github.com/user-attachments/assets/03cc4358-2357-45a7-87f1-94a1c776e845) | ![112](https://github.com/user-attachments/assets/99b5a739-6452-4a8b-9e5b-d44d9a2ff080) | ![113](https://github.com/user-attachments/assets/f5da20ed-6b24-436e-969d-bc00a15a1ae2) | ![114](https://github.com/user-attachments/assets/d70298f8-2ce7-4ddc-816b-acf72fc26692) |
| ![111](https://github.com/user-attachments/assets/deb73eeb-05fe-4fb5-bde5-4e038b4d5118) | ![112](https://github.com/user-attachments/assets/158890c4-8dc5-4009-847c-1c9abb5a82ae) | ![113](https://github.com/user-attachments/assets/f6d0f497-0a69-4a49-b2c4-1c3107b03f94) | ![114](https://github.com/user-attachments/assets/16ee403a-f316-479b-a7fb-11010bf12ca1) |
